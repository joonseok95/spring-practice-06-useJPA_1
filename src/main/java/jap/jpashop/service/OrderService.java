...
import jap.jpashop.domain.Delivery;
import jap.jpashop.domain.Member;
import jap.jpashop.domain.Order;
import jap.jpashop.domain.OrderItem;
import jap.jpashop.domain.item.Item;
import jap.jpashop.repository.ItemRepository;
import jap.jpashop.repository.MemberRepository;
